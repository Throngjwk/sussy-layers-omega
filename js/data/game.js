const game = {
    ...
    settings: {
        ...
        titleStyle: 2,
        theme: "sussy.css",
        layerNames: [["0.01","0.02","0.04","0.05","0.07","0.09","0.12","0.16","0.19","0.23","0.27","0.33","0.38","0.47","0.57","0.70","0.81","0.90","1.04","1.19","1.39","1.76","1.99","2.39","3.03","3.87","4.18","5.01","6.11","7.20","8.29","9.55","ω","ω+0.01","ω+0.03","ω+0.05","ω+0.08","ω+0.12","ω+0.17","ω+0.25","ω+0.30","ω+0.39","ω+0.44","ω+0.57","ω+0.63","ω+0.77","ω+0.90","ω+1.12","ω+1.36","ω+1.60","ω+2.00","ω+2.42","ω+3.01","ω+4.04","ω+5.12","ω+6.66","ω+7.98","ω+9.96","ω+ω"], "</-=+x>"],
    },
};
