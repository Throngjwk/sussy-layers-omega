const game = {
    ...
    achievements: [
        ...
        new Achievement("fisrt million", "1.00e6 aplha", "million", () => (game.layers[0] && game.layers[0].resource.gt(1e6)) || game.metaLayer.active),
        new Achievement("googol", "1.00e100 aplha", "10^100", () => (game.layers[0] && game.layers[0].resource.gt(1e100)) || game.metaLayer.active),
        new Achievement("pointy", "get epic pointy thing", "☛", () => (game.layers[1] && game.layers[1].resource.gt(1)) || game.metaLayer.active),
        new Achievement("double pointy", "get epic pointy thing", "2☛", () => (game.layers[1] && game.layers[1].resource.gt(2)) || game.metaLayer.active),
        new Achievement("5 pointy", "lol", "5☛", () => (game.layers[1] && game.layers[1].resource.gt(5)) || game.metaLayer.active),
        new Achievement("hundred pointy", "get 100 pointy", "100☛", () => (game.layers[1] && game.layers[1].resource.gt(100)) || game.metaLayer.active),
        new Achievement("Waiting for Exponential Idle...", "get 1e20 pointy", "1e20☛", () => (game.layers[1] && game.layers[1].resource.gt(1e20)) || game.metaLayer.active),
        ...
        new Achievement("turly sussy mode", "you are the turly impostor", PrestigeLayer.getNameForLayer(666), () => game.metaLayer.active),
        ...
        new Achievement("Ohhhhhhh", "1e400 i good?", PrestigeLayer.getNameForLayer(1e400), () => game.metaLayer.layer.gte("1e400")),
